...
public class ConnectionFactoryDB {
    ...
    public static final String URL = "jdbc:mysql://192.168.0.82:3306/RequestInfo?zeroDateTimeBehavior=convertToNull&rewriteBatchedStatements=true";
    public static final String USER = "root";
    public static final String PASSWORD = "root";
    public static final String DRIVER_CLASS = "com.mysql.jdbc.Driver"; 
    private static ConnectionFactoryDB instance1 = new ConnectionFactoryDB();
    public static final String URL_TEMPLATE_DB = "jdbc:mysql://192.168.0.82:3306/Template_Schema?zeroDateTimeBehavior=convertToNull&rewriteBatchedStatements=true";
